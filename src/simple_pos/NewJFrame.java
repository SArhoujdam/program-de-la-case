  ...
  public void addtable(int id ,String Name, int Qty ,Double Price){
   ...
   double tot = 0.0 ;
    ...
    private void initComponents() {
        ...
        lblBal.setFont(new java.awt.Font("Dialog", 1, 30)); // NOI18N
        lblBal.setText("00");
            ...
            .addGroup(jPanel3Layout.createSequentialGroup()
                ...
                .addGroup(jPanel3Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING, false)
                    .addGroup(jPanel3Layout.createSequentialGroup()
                        ...
                        .addGap(18, 18, 18)
                        .addGroup(jPanel3Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING, false)
                            .addComponent(lblBal, javax.swing.GroupLayout.DEFAULT_SIZE, 210, Short.MAX_VALUE)
                            .addComponent(pay))
                        .addGap(19, 19, 19))
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        ...
        somme=somme+2.99;
        total.setText(doubleFormat2(somme));
    ...
    private void jButton13ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton13ActionPerformed
       ...
       //remove Qty Lable
        ...
        switch (r) {
                   ...
                   case "1":                       
                   q1.setText("0");
                   total.setText(doubleFormat2(somme-2.99));
                   ...
                   case "2":                       
                   q2.setText("0");
                   total.setText(doubleFormat2(somme-2.59));
                   ...
                   case "3":                       
                   q3.setText("0");
                   total.setText(doubleFormat2(somme-7.99));
                   
                   break;
                   
                   case "4":                       
                   q4.setText("0");
                   total.setText(doubleFormat2(somme-9.29));
                       System.out.println(somme);
                   break;
                   
                   case "5":                       
                   q5.setText("0");
                   total.setText(doubleFormat2(somme-8.19));
                   System.out.println(somme);
                   break;
                   
                   case "6":                       
                   q6.setText("0");
                       total.setText(doubleFormat2(somme-3.99));
                       System.out.println(somme);
                   
                   case "7":                       
                   q7.setText("0");
                   total.setText(doubleFormat2(somme-12.99));
                       System.out.println(somme);
                   break;
                   
                   case "8":                       
                   q8.setText("0");
                   total.setText(doubleFormat2(somme-13.99));
                  
                   break;
                   
                   case "9":                       
                   q9.setText("0");
                   total.setText(doubleFormat2(somme-4.99));
                   System.out.println(somme);
                   break;
    ...
    private void jButton11ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton11ActionPerformed
        ...
        double result = paid - tot ;
       DecimalFormat df=new DecimalFormat("##.##");  
       
     String strResult=doubleFormat2(result);
      //  bal.setText(String.valueOf(df.format(balance)));
             lblBal.setText(strResult);
    ...
    private void jButton12ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton12ActionPerformed
        ...
        try {
           ...
           b.setText("                    9sys lm3lm\n");
         
            b.setText(b.getText() + "                        11 janvier bab dkala  \n");
            b.setText(b.getText() + "                         +212666721338, \n");
            b.setText(b.getText() + "---------------------------------------------------------------------\n");
            ...
            b.setText(b.getText() + "Balance   : " + lblBal.getText() +"\n");
            b.setText(b.getText() + "---------------------------------------------------------------------\n");
            b.setText(b.getText() + "                     Thanks For Your Business...!"+"\n");
            b.setText(b.getText() + "---------------------------------------------------------------------\n");
            b.setText(b.getText() + "                    Welcome back"+"\n");
